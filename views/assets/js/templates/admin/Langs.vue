                ...
                <div class="dashboard-body">
                    <div class="container">
                        <div class="col-xl-12 d-flex justify-content-end">
                            <b-button v-on:click="add_item">New Language</b-button>
                        </div>
                            ...
                            <div class="dash__wrapper">
                                ...
                                <div class="dash__body">
                                    <div class="body__line  text-center" v-for="(item) in items" :key="item.id">
                                        <div class="body__cell">{{ item.lang_code }}</div>
                                        <div class="body__cell">{{ item.lang_name }}</div>
